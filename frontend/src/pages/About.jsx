    ...
    <div className={`about-wrapper${darkMode ? ' dark' : ''}`}>
      ...
      >
        ...
        <motion.article variants={fadeIn} custom={1} className="about-block">
          ...
          <p>
            Подтвердите обработку логов, нажавав на кнопку  — и мы
            автоматически:
          </p>
          <ul className="about-list">
            <li>получим актуальные логи с API</li>
        ...
        <motion.article variants={fadeIn} custom={2} className="about-block">
          ...
          <ul className="about-list">
            <li>асинхронное получение логов;</li>
            <li>автоматическое виделение ключевых ошибок;</li>
            <li>
        ...
        <motion.article variants={fadeIn} custom={3} className="about-block">
          ...
          <ol className="about-list">
            <li>Вы подтверждаете обработку Logoв</li>
            <li>
              Алгоритм получает на них ссылки и извлекает текст и ищет{' '}
        ...
        <motion.article variants={fadeIn} custom={4} className="about-block">
          ...
          <div className="block-highlight">
            🔐 Мы не сохраняем метаданные.&nbsp;Всё —
            полностью анонимно.
          </div>
        </motion.article>
